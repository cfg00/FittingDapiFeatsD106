#conda activate cellpose2&&python D:\Carlos\Scripts\workers\workerDECONVOLUTIOND111.py
#
######### Please add documentation
### This is experiemnt D111, started on 12/8/2023
...
psf_file = r'D:\Carlos\Scripts\psfs\psf_750_Scope4_final.npy'


#saving onto merfish8v1
#P:\Quan\D111_12_01_2023__AJBBqzbb_chr14
save_folder = r'P:\Quan\D111_12_01_2023__AJBBqzbb_chr14\AnalysisDeconvolveCG'
#D:\Carlos\Scripts\flat_field\Scope4_med_col_raw
flat_field_fl = r'D:\Carlos\Scripts\flat_field\Scope4_med_col_raw'
...
def main_do_compute_fits(save_folder,fld,fov,icol,save_fl,psf,old_method,icol_flat):
    ...
    if old_method:
        ...
        fl_med = flat_field_fl+str(icol)+'.npz' ###############################################################################################3 change this to npz?
...
def main_f(set_ifov,try_mode=True):
    ...
    #P:\Quan\D111_12_01_2023__AJBBqzbb_chr14 (this is on merfish 12)
    
    all_flds_ = glob.glob(r'P:\Quan\D111_12_01_2023__AJBBqzbb_chr14\H*DMER*'+set__) ################################# modify for 3-col small tad 
